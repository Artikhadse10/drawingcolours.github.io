...
jQuery(document).ready(function($){
		$('.wpdp_settings_fields .refresh_wpdp a').on('click', function(e){
	...
	$('body').on('focusout','#wpdp_form input:not(.ignore-save):not(:radio):not(:checkbox), #wpdp_form textarea:not(.ignore-save)', function(){
